...
export const Article = ({match}) => {
  ...
  const [{response: fetchArticleResponse, isLoading: fetchArticleIsLoading, error: fetchArticleError}, doFetch] = useFetch(
    apiUrl
  )
  ...
  if (fetchArticleIsLoading || !fetchArticleResponse) return <Loading />
  if (fetchArticleError) return <ErrorMessage />
